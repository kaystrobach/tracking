...
class BotsTest extends TestCase
{
    ...
    public function returnsBotForPageview(string $userAgent, string $expectedBot): void
    {
        ...
        static::assertSame('bot', $tags[0]->getName());
        static::assertSame('yes', $tags[0]->getValue());
        static::assertSame('bot_name', $tags[1]->getName());
        static::assertSame($expectedBot, $tags[1]->getValue());
    }
    ...
    public function possibleUserStringWithBots(): array
    {
        return [
            ...
            18 => [
                ...
                'expectedBot' => 'hgfAlphaXCrawl - Uni Passau',
            ],
            19 => [
